...
final class ReflexBlitzComponentsTests: XCTestCase {
    ...
    func testCardViewChoiceStatesDerivationInReviewedMode() {
        ...
        XCTAssertFalse(wrongCard.showsStatusIndicator(for: optionHabit))
        XCTAssertFalse(wrongCard.showsStatusIndicator(for: optionFocus))
        ...
        XCTAssertFalse(correctCard.showsStatusIndicator(for: optionHabit))
        ...
        XCTAssertFalse(timeoutCard.showsStatusIndicator(for: optionHabit))
