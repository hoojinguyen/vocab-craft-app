...
final class SpeechWordHighlightViewTests: XCTestCase {
    ...
    func testSpeechWordHighlightView_colorMappingExactMatch() {
        let backgroundColor = SpeechWordHighlightView.backgroundColor(for: .exactMatch)
        let foregroundColor = SpeechWordHighlightView.foregroundColor(for: .exactMatch)
    ...
    func testSpeechWordHighlightView_colorMappingFuzzyMatch() {
        let backgroundColor = SpeechWordHighlightView.backgroundColor(for: .fuzzyMatch)
        let foregroundColor = SpeechWordHighlightView.foregroundColor(for: .fuzzyMatch)
    ...
    func testSpeechWordHighlightView_colorMappingMissing() {
        let backgroundColor = SpeechWordHighlightView.backgroundColor(for: .missing)
        let foregroundColor = SpeechWordHighlightView.foregroundColor(for: .missing)
