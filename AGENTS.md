...
## 1. Strict Localization & Text Rendering Rules
...
### 1.1 Key Naming Taxonomy Standard
...
### 1.2 Mandatory 100% Bilingual Parity (EN & VI)
...
### 1.3 How to Render Text in Code
