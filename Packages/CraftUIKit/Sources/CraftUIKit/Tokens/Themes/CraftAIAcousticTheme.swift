...
public struct CraftAIAcousticColorTokens: CraftColorTokens {
    ...
    public init(
        ...
        borderFocus: Color = Color(hex: 0x3B82F6),
        ...
        streakStarter: Color = Color(hex: 0x3B82F6),
        streakBlaze: Color = Color(hex: 0x8B5CF6),
        streakLegendary: Color = Color(hex: 0x06B6D4),
        streakFreeze: Color = Color(hex: 0x38BDF8),
        streakPending: Color = Color(hex: 0x64748B),
        streakGlow: Color = Color(hex: 0x3B82F6).opacity(0.40),
        pathCompleted: Color = Color(hex: 0x10B981),
        pathActive: Color = Color(hex: 0x3B82F6),
        ...
        pathHaloGlow: Color = Color(hex: 0x3B82F6).opacity(0.30)
    ) {
