...
public struct CraftNordicZenColorTokens: CraftColorTokens {
    ...
    public init(
        ...
        borderFocus: Color = .craftDynamic(light: Color(hex: 0x7C3AED), dark: Color(hex: 0x8B5CF6)),
        ...
        streakStarter: Color = .craftDynamic(light: Color(hex: 0x7C3AED), dark: Color(hex: 0x8B5CF6)),
        streakBlaze: Color = .craftDynamic(light: Color(hex: 0x9333EA), dark: Color(hex: 0xA855F7)),
        ...
        streakPending: Color = .craftDynamic(light: Color(hex: 0x94A3B8), dark: Color(hex: 0x71717A)),
        streakGlow: Color = .craftDynamic(light: Color(hex: 0x7C3AED).opacity(0.25), dark: Color(hex: 0x8B5CF6).opacity(0.30)),
        pathCompleted: Color = .craftDynamic(light: Color(hex: 0x059669), dark: Color(hex: 0x34D399)),
        pathActive: Color = .craftDynamic(light: Color(hex: 0x7C3AED), dark: Color(hex: 0x8B5CF6)),
        ...
        pathHaloGlow: Color = .craftDynamic(light: Color(hex: 0x7C3AED).opacity(0.15), dark: Color(hex: 0x8B5CF6).opacity(0.18))
    ) {
