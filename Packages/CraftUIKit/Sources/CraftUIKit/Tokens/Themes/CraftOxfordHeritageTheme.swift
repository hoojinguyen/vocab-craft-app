...
public struct CraftOxfordHeritageColorTokens: CraftColorTokens {
    ...
    public init(
        ...
        borderFocus: Color = Color(hex: 0x0A2540),
        ...
        statusWarning: Color = Color(hex: 0xC59B27),
        statusDanger: Color = Color(hex: 0x8B1E2D),
        statusInfo: Color = Color(hex: 0x0284C7),
        streakStarter: Color = Color(hex: 0xC59B27),
        streakBlaze: Color = Color(hex: 0x8B1E2D),
        streakLegendary: Color = Color(hex: 0x7C3AED),
        streakFreeze: Color = Color(hex: 0x38BDF8),
        streakPending: Color = Color(hex: 0x94A3B8),
        streakGlow: Color = Color(hex: 0xC59B27).opacity(0.35),
        pathCompleted: Color = Color(hex: 0x10B981),
        pathActive: Color = Color(hex: 0x0A2540),
        ...
        pathHaloGlow: Color = Color(hex: 0xC59B27).opacity(0.25)
    ) {
