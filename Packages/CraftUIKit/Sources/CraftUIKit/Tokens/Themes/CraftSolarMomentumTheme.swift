...
public struct CraftSolarMomentumColorTokens: CraftColorTokens {
    ...
    public init(
        ...
        borderFocus: Color = .craftDynamic(light: Color(hex: 0xEA580C), dark: Color(hex: 0xFF6B4A)),
        ...
        streakStarter: Color = .craftDynamic(light: Color(hex: 0xEA580C), dark: Color(hex: 0xFF6B4A)),
        streakBlaze: Color = .craftDynamic(light: Color(hex: 0xC2410C), dark: Color(hex: 0xFB923C)),
        streakLegendary: Color = .craftDynamic(light: Color(hex: 0xDB2777), dark: Color(hex: 0xF472B6)),
        ...
        streakGlow: Color = .craftDynamic(light: Color(hex: 0xEA580C).opacity(0.35), dark: Color(hex: 0xFF6B4A).opacity(0.40)),
        pathCompleted: Color = .craftDynamic(light: Color(hex: 0x059669), dark: Color(hex: 0x34D399)),
        pathActive: Color = .craftDynamic(light: Color(hex: 0xEA580C), dark: Color(hex: 0xFF6B4A)),
        ...
        pathHaloGlow: Color = .craftDynamic(light: Color(hex: 0xEA580C).opacity(0.24), dark: Color(hex: 0xFF6B4A).opacity(0.28))
    ) {
