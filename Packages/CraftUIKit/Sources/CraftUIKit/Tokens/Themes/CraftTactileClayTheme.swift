...
public struct CraftTactileClayColorTokens: CraftColorTokens {
    ...
    public init(
        ...
        borderFocus: Color = Color(hex: 0xD96B43),
        hairline: Color = .craftDynamic(light: Color(hex: 0xE5DFD5).opacity(0.8), dark: Color(hex: 0x302A26).opacity(0.8)),
        statusSuccess: Color = Color(hex: 0x65A30D),
        statusWarning: Color = Color(hex: 0xD97706),
        statusDanger: Color = Color(hex: 0xDC2626),
        statusInfo: Color = Color(hex: 0x2563EB),
        streakStarter: Color = Color(hex: 0xD96B43),
        streakBlaze: Color = Color(hex: 0xEA580C),
        streakLegendary: Color = Color(hex: 0x4F46E5),
        streakFreeze: Color = Color(hex: 0x38BDF8),
        streakPending: Color = Color(hex: 0x78716C),
        streakGlow: Color = Color(hex: 0xD96B43).opacity(0.35),
        pathCompleted: Color = Color(hex: 0x65A30D),
        pathActive: Color = Color(hex: 0xD96B43),
        ...
        pathHaloGlow: Color = Color(hex: 0xD96B43).opacity(0.22)
    ) {
