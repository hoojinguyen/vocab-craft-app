...
public struct CraftKyotoMatchaColorTokens: CraftColorTokens {
    ...
    public init(
        ...
        borderFocus: Color = Color(hex: 0x3D6B52),
        hairline: Color = .craftDynamic(light: Color(hex: 0xE3DED4).opacity(0.8), dark: Color(hex: 0x22332C).opacity(0.8)),
        statusSuccess: Color = Color(hex: 0x52B788),
        statusWarning: Color = Color(hex: 0xE09F3E),
        statusDanger: Color = Color(hex: 0xE76F51),
        statusInfo: Color = Color(hex: 0x457B9D),
        streakStarter: Color = Color(hex: 0xE09F3E),
        streakBlaze: Color = Color(hex: 0xE76F51),
        streakLegendary: Color = Color(hex: 0x84A98C),
        streakFreeze: Color = Color(hex: 0x52B788),
        streakPending: Color = Color(hex: 0x94A3B8),
        streakGlow: Color = Color(hex: 0xE09F3E).opacity(0.35),
        pathCompleted: Color = Color(hex: 0x52B788),
        pathActive: Color = Color(hex: 0x3D6B52),
        ...
        pathHaloGlow: Color = Color(hex: 0x52B788).opacity(0.20)
    ) {
