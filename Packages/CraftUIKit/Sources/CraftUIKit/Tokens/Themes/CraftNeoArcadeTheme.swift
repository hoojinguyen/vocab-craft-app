...
public struct CraftNeoArcadeColorTokens: CraftColorTokens {
    ...
    public init(
        ...
        pathHaloGlow: Color = Color(hex: 0x84CC16).opacity(0.25)
    ) {
